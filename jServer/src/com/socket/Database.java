...
public class Database {
    ...
    public boolean checkLogin(String username, String password){
        ...
        try{
            ...
            for (int temp = 0; temp < nList.getLength(); temp++) {
                ...
                if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                    Element eElement = (Element) nNode;
                    if(getTagValue("username", eElement).equals(username) && getTagValue("password", eElement).equals(hashPassword(password))){
                        return true;
                    }
                }
            }
    ...
    public void addUser(String username, String password){
        ...
        try {
            ...
            Element newpassword = doc.createElement("password"); newpassword.setTextContent(hashPassword(password));
    ...
    //////////////////////////////hashing end for password encryption /////////////////////////////////////
