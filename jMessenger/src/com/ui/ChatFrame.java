...
public class ChatFrame extends javax.swing.JFrame {
    ...
    public ChatFrame() {
        ...
        this.addWindowListener(new WindowListener() {
            ...
            @Override public void windowClosing(WindowEvent e) { try{ client.send(new Message("message", username, ".bye", "SERVER","false",null,"not Hmac")); clientThread.stop();  }catch(Exception ex){} }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!serverAddr.isEmpty() && !jTextField2.getText().isEmpty()){
            try{
                ...
                clientThread.start();
                client.send(new Message("test", "testUser", "testContent", "SERVER","false",null,"not Hmac"));
            }
            catch(Exception ex){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        client.generateKeys();
        client.send(new Message("login", username, "serverDh", "SERVER","false",client.publicKey,"not Hmac"));
        }
        
       
            //client.send(new Message("login", username, password, "SERVER","false",null,"not Hmac"));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(!msg.isEmpty() && !target.isEmpty()){
            ...
            client.generateKeys();
            PublicKey  pKey = client.publicKey;
            System.out.println("pkey-->"+pKey);
            
            client.send(new Message("message", username, "DH message1", target,"true",pKey,"not Hmac"));//you are hereeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(!username.isEmpty() && !password.isEmpty()){
        client.generateKeys();
        client.send(new Message("signup", username, "serverDh", "SERVER","false",client.publicKey,"not Hmac"));
        
        
       
         // client.send(new Message("signup", username, password, "SERVER","false",null,"not Hmac"));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
            ...
            if(size < 120 * 1024 * 1024){
                client.send(new Message("upload_req", username, file.getName(), jList1.getSelectedValue().toString(),"false",null,"not Hmac"));
            }
            else{
